        ...
        // Função auxiliar para desligar a cor do botão ativo
        function resetarBotaoAudio() {
            if (botaoAudioAtual) {
                // Remove o brilho e devolve a cor original
        ...
        function tocarAudio(botao, url, texto) {
            ...
            // Para qualquer áudio que estiver tocando ants de iniciar o novo 
            if (audioAtual) {
                audioAtual.pause(); 
            ...
            // Apaga a luz do botão anterior 
            resetarBotaoAudio(); 

            // Acende a luz do botão novo (Inverte as cores)
            ...
            // Se o texto tiver mais de 150 caracteres, usa o sintetizador nativo
            if (texto && texto.length > 150) {
                const sintese = new SpeechSynthesisUtterance(texto);
                sintese.lang = 'en-US'; 

                // Desliga o botão automaticamente quando a voz terminar 
            ...
            if (url && url.startsWith('http')) {
                ...
                // Desliga o botão automaticamente quando o áudio terminar
